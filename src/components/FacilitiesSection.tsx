...
const FacilitiesSection = () => {
  ...
  return (
    <section id="facilities" ref={sectionRef} className="section-padding bg-transparent relative z-10">
      <div className="container mx-auto text-center">
        ...
        <div className="facility-grid grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {facilities.map((f) => (
            <div key={f.title} className="facility-card glass-panel p-8 text-left group">
        ...
        <div className="technical-content mt-12 py-12 border-t border-gold/20">
          <div className="grid lg:grid-cols-2 gap-10 items-stretch text-left">
            <div className="glass-panel p-8 md:p-10 border border-gold/20 rounded-lg">

...
const BookingBanner = () => {
  ...
  return (
    <section ref={ref} className="py-16 bg-transparent relative z-10">
      <div className="container mx-auto px-4">
        ...
        <div className="absolute inset-0" style={{
          ...
          <div className="py-12 px-4 text-center banner-content relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#contact" className="btn-primary bg-gold text-background hover:bg-gold-light">
                Book Now
              </a>
              <a
                href="tel:+918767759598"
                className="inline-flex items-center justify-center gap-2 px-8 py-3 border-2 border-gold text-gold font-body font-medium text-sm text-center uppercase tracking-[0.15em] transition-all duration-300 hover:bg-gold hover:text-background"
              >
                <Phone size={16} />
                +91 87677 59598
              </a>

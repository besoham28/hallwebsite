...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const phoneNumber = "918767759598"; // Venue's WhatsApp number
  ...
  const inputClasses = "w-full px-4 py-3 bg-white/5 border border-white/10 text-foreground font-body text-base backdrop-blur-sm focus:outline-none focus:border-gold transition-colors";

  return (
    <section id="contact" ref={sectionRef} className="section-padding bg-transparent relative z-10">
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="contact-left">
            ...
            <div className="space-y-6">
              {[
                ...
                { icon: Phone, label: "Phone", value: "+91 87677 59598" },
          ...
          <div className="contact-form glass-panel p-8 relative overflow-hidden rounded-xl">

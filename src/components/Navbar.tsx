  ...
  return (
    ...
    >
      <div className="w-full px-4 sm:px-6 md:px-10 lg:px-12 xl:px-16 flex items-center justify-between">
        <a href={resolveUrl("#home")} className="flex flex-col">
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-gold text-background px-5 py-2.5 text-xs uppercase tracking-wider font-body font-bold transition-all duration-300 hover:bg-gold-light"
          >
            Book Now
          </a>
        </div>
        ...
        <button
          ...
          className={`lg:hidden p-2 rounded-full transition-all duration-300 ${
            scrolled 
              ...
              : "text-background bg-gold/80 backdrop-blur-md hover:bg-gold" // Enhanced visibility for light backgrounds
          }`}
        >
        ...
        <div className="lg:hidden bg-royal/98 backdrop-blur-lg border-t border-gold/20 animate-fade-up">
          <div className="w-full px-4 py-6 flex flex-col gap-4">
            ...
            <a
              href={resolveUrl("#contact")}
              onClick={() => setIsOpen(false)}
              className="flex items-center justify-center gap-2 bg-gold text-background py-4 text-sm uppercase tracking-wider font-body font-bold transition-all active:scale-95 mt-4"
            >
              Book Now
            </a>
          </div>
